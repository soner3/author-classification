...
def load_authorship_dataset(dataset_path: str, encode_labels: bool = True) -> tuple[pd.DataFrame, LabelEncoder]:
    """
    ...
    Returns:
        Tuple containing:
            - pd.DataFrame with columns ['author', 'text', 'label']
            - LabelEncoder instance (used to decode numeric predictions later)
    """
    data = []
